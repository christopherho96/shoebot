...
try:
    ...
    browser.find_element_by_xpath("//input[@name='line1']").send_keys(info[3])
    browser.find_element_by_xpath("//input[@name='town']").send_keys(info[4])
    ...
    browser.find_element_by_xpath("//input[@id='expiry_date_text']").send_keys(info[10])
    browser.find_element_by_xpath("//input[@id='cvd_input']").send_keys(info[11])
